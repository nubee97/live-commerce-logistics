...
//     const brandCode = maybeCode || pad3(autoIndex++);
//     return {
//       id: newId(),
//       brandCode,
//       brandName,
...
//     const resolvedSku =
//       String(row.sku || "").trim() || buildSku(resolvedBrandCode, resolvedProductCode);
...
//       consumerPrice: Number(row.consumerPrice || 0),
//       lowestPrice: Number(row.lowestPrice || 0),
//       livePrice: Number(row.livePrice || 0),
...
//     const aliasHit = (state.aliasTable || []).some(
//       (a) =>
//         a.active &&
//         a.targetSku === row.sku &&
//         normalizeText(a.aliasName).includes(q)
//     );
...
//   return (state.catalogGifts || state.gifts || []).find((g) => g.giftCode === code);
// }
