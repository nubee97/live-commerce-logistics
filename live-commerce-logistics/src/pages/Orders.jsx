  ...
  return (
    <>
      ...
      <div className="ordersPremiumPage">
        <section className="ordersPremiumHero">
          <div>
            ...
            <p className="ordersPremiumSubtitle">
              Clean, premium workflow for drafting, reviewing, confirming, and
              managing your live commerce logistics orders.
            </p>
          </div>
        ...
        <div className="ordersPremiumGrid">
          <section className="ordersPremiumPanel ordersPremiumSidebar">
            ...
            <div className="ordersPremiumFilterBar">
              <input
            ...
            {!selected ? (
              ...
              <>
                <div className="ordersPremiumPanelHead">
                  <div>
                    <h2>Order Details</h2>
                    <p>Customer, shipping, and delivery information.</p>
                  </div>
                ...
                <div className="ordersPremiumFormGrid">
                  <div className="ordersPremiumFieldBlock">
                    ...
                    <input
                      ...
                      disabled={isLocked || saving}
                      onChange={(e) =>
                        updateOrderPatch({ customerName: e.target.value })
                      }
                      placeholder="Customer account / buyer name"
                    />
                  </div>
                  ...
                  <div className="ordersPremiumFieldBlock">
                    ...
                    <input
                      ...
                      disabled={isLocked || saving}
                      onChange={(e) =>
                        rebuildAddress({ recipientName: e.target.value })
                      }
                      placeholder="Actual receiver name"
                    />
                  </div>
                  ...
                  <div className="ordersPremiumFieldBlock">
                    ...
                    <select
                      ...
                      disabled={isLocked || saving}
                      onChange={(e) =>
                        updateOrderPatch({ shippingMethod: e.target.value })
                      }
                    >
                      <option value="퀵">퀵</option>
                      <option value="택배">택배</option>
                  ...
                  <div className="ordersPremiumAddressCard full">
                    ...
                    <div className="ordersPremiumAddressRow">
                      <input
                        ...
                        disabled={isLocked || saving}
                        onChange={(e) =>
                          rebuildAddress({ postalCode: e.target.value })
                        }
                        placeholder="우편번호"
                      />
                    ...
                    <div className="ordersPremiumAddressStack">
                      <input
                        ...
                        disabled={isLocked || saving}
                        onChange={(e) =>
                          rebuildAddress({ addressMain: e.target.value })
                        }
                        placeholder="주소"
                      />
                      ...
                      <input
                        ...
                        disabled={isLocked || saving}
                        onChange={(e) =>
                          rebuildAddress({ addressDetail: e.target.value })
                        }
                        placeholder="상세주소"
                      />
                    </div>
                  ...
                  <div className="ordersPremiumFieldBlock full">
                    ...
                    <select
                      ...
                      disabled={isLocked || saving}
                      onChange={(e) =>
                        rebuildAddress({ deliveryMemo: e.target.value })
                      }
                    >
                      <option value="">배송메모를 선택해 주세요.</option>
            ...
            {!selected ? (
              ...
              <>
                <div className="ordersPremiumPanelHead">
                  <div>
                    <h2>Order Builder</h2>
                    <p>Build, review, and confirm your order step by step.</p>
                  </div>
                </div>

                <div className="ordersPremiumStepCard">
                  <div className="ordersPremiumStepLabel">STEP 1</div>
                  <h3>Add Items</h3>
                  <p>Choose what you want to include in this order.</p>
                ...
                <div className="ordersPremiumStepCard">
                  <div className="ordersPremiumStepHead">
                    <div>
                      ...
                      <p>Review and edit the items currently added.</p>
                    </div>
                ...
                <div className="ordersPremiumStepCard">
                  ...
                  <p>Check the totals and warnings before confirming.</p>
                ...
                <div className="ordersPremiumStepCard">
                  ...
                  <h3>Stock Check</h3>
                  <p>Confirm available stock before final submission.</p>
